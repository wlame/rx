...
class TestContextZero:
    ...
    def test_context_zero_shows_matches(self):
        ...
        result = self.runner.invoke(trace_command, ['error', self.test_file, '--samples', '--context', '0'])
    ...
    def test_context_zero_json_output(self):
        ...
        result = self.runner.invoke(trace_command, ['error', self.test_file, '--samples', '--context', '0', '--json'])
...
class TestMatchesNearEndOfFile:
    ...
    def test_match_on_last_line_with_context_1(self):
        ...
        result = self.runner.invoke(trace_command, ['last_line', self.test_file, '--samples', '--context', '1'])
    ...
    def test_match_on_second_to_last_line_with_context_1(self):
        ...
        result = self.runner.invoke(trace_command, ['second_to_last', self.test_file, '--samples', '--context', '1'])
    ...
    def test_match_on_last_line_with_context_2(self):
        ...
        result = self.runner.invoke(trace_command, ['last_line', self.test_file, '--samples', '--context', '2'])
    ...
    def test_all_matches_show_with_json(self):
        ...
        result = self.runner.invoke(trace_command, ['match', self.test_file, '--samples', '--context', '1', '--json'])
...
class TestConsecutiveMatches:
    ...
    def test_consecutive_matches_show_in_each_others_context_1(self):
        ...
        result = self.runner.invoke(
            trace_command,
            ['-e', 'pattern_a', '-e', 'pattern_b', '-e', 'pattern_c', self.test_file, '--samples', '--context', '1'],
        )
    ...
    def test_consecutive_matches_show_in_each_others_context_2(self):
        ...
        result = self.runner.invoke(
            trace_command, ['-e', 'pattern_a', '-e', 'pattern_b', self.test_file, '--samples', '--context', '2']
        )
    ...
    def test_consecutive_matches_complete_context_json(self):
        ...
        result = self.runner.invoke(
            trace_command,
            ['-e', 'pattern_a', '-e', 'pattern_b', self.test_file, '--samples', '--context', '2', '--json'],
        )
    ...
    def test_consecutive_matches_on_last_lines(self):
        ...
        result = self.runner.invoke(
            trace_command, ['-e', 'penultimate', '-e', 'ultimate', test_file, '--samples', '--context', '1']
        )
...
class TestContextCombinations:
    ...
    def test_context_4_shows_4_lines_before_and_after(self):
        ...
        result = self.runner.invoke(trace_command, ['match', self.test_file, '--samples', '--context', '4'])
    ...
    def test_asymmetric_context_before_2_after_1(self):
        ...
        result = self.runner.invoke(
            trace_command, ['match', self.test_file, '--samples', '--before', '2', '--after', '1']
        )
