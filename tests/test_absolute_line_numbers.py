...
class TestAbsoluteLineNumbers:
    ...
    def test_absolute_line_number_cache_reconstruction(self):
        """Test that cached matches preserve absolute_line_number."""
        # Create a large file to trigger caching (>50MB)
        large_file = os.path.join(self.temp_dir, "large.txt")
        line = "a" * 1000 + " pattern match here\n"
        line_count = 60000  # ~60MB
        ...
        # Both should have absolute_line_number
